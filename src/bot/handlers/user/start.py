...
async def cmd_help(message: Message, db_user: dict | None = None):
    ...
    help_text = (
        ...
        "#bot — AI suhbat\n\n"
        "<b>Guruh o'yinlari:</b>\n"
        "/guruhoyinlar — Barcha o'yinlar ro'yxati\n"
        "/soztopish — Sinonim/Antonim o'yini\n"
        "/tarjimapoyga — Tarjima poygasi\n"
        "/xatotopish — Xato topish o'yini\n"
        "/raqamtop — Raqam topish\n"
        "/tezhisob — Tez hisob\n"
        "/mafia — Mafiya o'yini\n"
        "/scores — Guruh reytingi\n"
        "/stopoyun — O'yinni to'xtatish\n\n"
        "<b>Inline rejim:</b>\n"
        "@bot check: text\n"
        "@bot tr: text\n"
        "@bot p: us: word"
